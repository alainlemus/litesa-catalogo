<div>
    <!-- Breadcrumb -->
    <div class="bg-[var(--color-primary)] border-b">
        <div class="container px-4 py-4 mx-auto">
            <div class="flex items-center space-x-2 text-sm">
                <a href="{{ route('catalog') }}" class="flex items-center text-white hover:text-white">
    ...
    <div class="container flex-grow h-full px-4 py-8 mx-auto mt-22 mb-22">
        <div class="grid grid-cols-1 gap-12 lg:grid-cols-2">
                ...
                <div class="space-y-4">
                    ...
                    <div class="relative overflow-hidden bg-white shadow-lg rounded-2xl">
                        <div class="flex items-center justify-center p-8 aspect-square">
                            <img id="mainImage" src="{{  asset('storage/' . $product->photos->first()->path) }}" alt="LÁMPARA MR 16 Y GU10 - Vista 1" class="object-fill max-w-full max-h-full"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="p-8 bg-white shadow-lg rounded-2xl">
                    ...
                    <h1 class="mb-2 text-3xl font-bold text-litesa-purple">{{ $product->name }}</h1>
                    <div class="flex flex-wrap items-center gap-2 space-x-4">
                        <div class="inline-flex items-center px-3 py-1 text-sm font-bold text-white bg-yellow-300 rounded-full">
                        ...
                        <div class="inline-flex items-center px-3 py-1 text-sm font-bold text-yellow-500 border-yellow-500 rounded rounded-full bg-litesa-yellow border-1">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        ...
                        <div class="inline-flex items-center px-3 py-1 text-sm font-bold text-yellow-500 border-yellow-500 rounded rounded-full bg-litesa-yellow border-1">
                            ...
                            <span class="p-1 text-yellow-500">{{ $product->certification }}</span>
                        </div>
                        <div class="inline-flex items-center px-3 py-1 text-sm font-bold text-yellow-500 border-yellow-500 rounded rounded-full bg-litesa-yellow border-1">
                            <span class="p-1 text-yellow-500">{{ $product->base }}</span>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-start pt-6">
                        ...
                        <h4 class="pl-3 mb-3 font-semibold text-litesa-purple">
                            Usos
                        </h4>
                    </div>
                    <ul class="space-y-2">
                    ...
                    <div class="mt-16">
                        <div class="w-full">
                            ...
                            <div id="specifications" class="mt-6 tab-content">
                                <div class="p-8 bg-white shadow-lg rounded-2xl">
                                    <h3 class="mb-4 text-xl font-bold text-litesa-purple">Variantes</h3>
                                    <div class="overflow-x-auto">
                                        <table class="w-full border-collapse">
                                            <thead>
                                                <tr class="text-white bg-[var(--color-primary)] border-b-1">
